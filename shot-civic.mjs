/* shot-civic.mjs — iter 122. hovershot.mjs aims at ENTITIES via __ents; this
 * aims at TILES via __find, so the civic tooltip can be screenshotted.
...
const [seed = '42', warp = '11', outDir = 'shots/civic', yr = ''] = process.argv.slice(2);
...
/* choose a civic hex near frame centre */
...
for (const kind of ['library', 'parliament', 'hospital', 'quad', 'plaza']) {
